...
public class OrderHead {
	...
	public OrderHead(JSONObject jsonHead) {
		this.orderNo=jsonHead.getString("orderNo");
		this.goodsValue=jsonHead.getString("goodsValue");
		this.freight=jsonHead.getString("freight");
		this.discount=jsonHead.getString("discount");
		this.taxTotal=jsonHead.getString("taxTotal");
		this.acturalPaid=jsonHead.getString("acturalPaid");
		this.buyerRegNo=jsonHead.getString("buyerRegNo");
		this.buyerName=jsonHead.getString("buyerName");
		this.buyerIdNumber=jsonHead.getString("buyerIdNumber");
		this.purchasertelephone=jsonHead.getString("purchasertelephone");
		this.payCode=jsonHead.getString("payCode");
		this.payTrCsactionId=jsonHead.getString("payTrCsactionId");
		this.consignee=jsonHead.getString("consignee");
		this.consigneeTelephone=jsonHead.getString("consigneeTelephone");
		this.consigneeAddress=jsonHead.getString("consigneeAddress");
		this.note=jsonHead.getString("note");
		this.senderusername=jsonHead.getString("senderusername");
		this.senderuseraddress=jsonHead.getString("senderuseraddress");
		this.senderusertelephone=jsonHead.getString("senderusertelephone");
		this.billmode=jsonHead.getString("billmode");
		this.wasterornot=jsonHead.getString("wasterornot");
		this.botanyornot=jsonHead.getString("botanyornot");
		this.trepcodeinsp=jsonHead.getString("trepcodeinsp");
		this.weight=jsonHead.getString("weight");
		this.netweight=jsonHead.getString("netweight");
		this.collusercountryinsp=jsonHead.getString("collusercountryinsp");
	}

...
public class OrderDetail {
	...
	public OrderDetail(JSONObject jsonDetail) {
		this.qty=jsonDetail.getString("qty");
		this.price=jsonDetail.getString("price");
		this.flag=jsonDetail.getString("flag");
		this.packcategoryinsp=jsonDetail.getString("packcategoryinsp");
		this.gno=jsonDetail.getString("gno");
	}
